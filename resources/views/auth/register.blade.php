    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="/">Learn Network - Lee County</a>
            </div>
            ...
            <div class="header-content-inner">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                    ...
                    <div class="form-group{{ $errors->has('first') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" name="first" value="{{ old('first') }}">
                    ...
                    <div class="form-group{{ $errors->has('last') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" name="last" value="{{ old('last') }}">
